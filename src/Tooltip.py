...
class Tooltip(ttk.Frame):
    ...
    def __init__(self, master=None, headertext="Help", text="Some great help is displayed here.", width=200, timeout=1,
                 background=None, offset=(2, 2), showheader=True, static=False, **kwargs):
        """
        Create a Tooltip
    ...
    def show(self):
        ...
        self._canvas = tk.Canvas(self._toplevel, background=background, highlightbackground=border, highlightthickness=1)
        self.header_label = ttk.Label(self._canvas, text=self.__headertext, background=background,
